...
waves0 = simulate_gt(gt, k0, [1,2];Nt = 80, tag = false)
hs=SimpleFermionHamiltonian([StandardFermionicString(-0.5, creation(n1+1),creation(1),annilation(n1+1), annilation(1))])
waves = simulate_gt(gt, k0, [1,2];Nt = 80, tag = false,hs)
